    ...
    <div className="fixed z-10 overflow-y-auto top-0 w-full left-0" id="modal">
      <div className="flex items-center justify-center min-height-100vh pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        >
          ...
          <div className="px-5 w-[750px] h-[550px] py-5 bg-white overflow-y-auto">
            <div>
              <img
                src={url + open?.image}
              ...
              <h1 className="font-bold py-5">{open.title}</h1>
            ...
            <div>
              ...
              <form>
                <input
                  type="text"
                  className="w-full border-2 border-purple-500 px-2 py-2"
                />
                <textarea
                  name="comment"
                  id=""
